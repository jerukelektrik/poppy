	...
	<section class="relative overflow-hidden bg-[linear-gradient(135deg,#EEF9D9_0%,#99EAA7_100%)] pt-24 pb-0 md:pt-36 md:pb-24 lg:pt-40 lg:pb-32 rounded-b-[32px] md:rounded-b-[48px] lg:rounded-b-[60px]">
		<div class="poppy-container relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-6 md:gap-12 lg:gap-8 items-center">
			...
			<div class="lg:col-span-7 flex flex-col justify-center text-left">
				...
				<!-- Pill Badge -->
				<div class="mb-4">
					<div class="hero-pill-badge bg-[#EEF9D9] border border-[#99EAA7] text-poppy-ink font-extrabold rounded-full select-none" style="padding: clamp(4px, 0.8vw, 8px) clamp(10px, 1.8vw, 24px) !important; display: inline-flex !important; align-items: center !important; white-space: nowrap !important;">
				...
				<h2 class="text-3xl sm:text-4xl md:text-5xl lg:text-[52px] font-black leading-[1.15] mb-6 text-poppy-ink max-w-[640px]">
					...
					<span class="block">Lewat Metode Bermain</span>
					<span class="block">yang Super Seru</span>
				</h2>
			...
			<div class="bg-[linear-gradient(135deg,#EEF9D9_0%,#99EAA7_100%)] rounded-[32px] md:rounded-[48px] lg:rounded-[60px] py-16 px-6 sm:px-12 md:px-16 lg:px-20 relative overflow-hidden">
				...
				<div class="text-center max-w-3xl mx-auto mb-16">
					<h2 class="text-2xl sm:text-3xl md:text-4xl font-black font-serif text-poppy-ink inline-block relative mb-4">
						Pilih Program Kursus Bahasa Inggris Terbaik untuk
						<span class="relative inline-block text-poppy-ink">
							<!-- Decorative curved line under the highlighted phrase (red) -->
					...
					<p class="text-xs sm:text-sm text-poppy-muted font-semibold leading-relaxed mt-6">
						Kurikulum yang dirancang untuk membantu anak mengembangkan kemampuan listening, speaking, reading, dan writing melalui pembelajaran yang aktif dan menyenangkan.
					</p>
				</div>
				...
				<div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 relative z-10">
						...
						<div>
							...
							<div class="p-6 text-left">
								<p class="text-xs text-poppy-muted leading-relaxed mb-6 font-medium">
									Pengenalan Bahasa Inggris melalui lagu, permainan, cerita, dan aktivitas interaktif untuk membangun minat belajar serta kosakata dasar anak.
								</p>
							</div>
						</div>
						<!-- Footer/Price -->
					...
					<div class="bg-white rounded-[24px] overflow-hidden shadow-md flex flex-col justify-between border-b-[8px] border-poppy-ink">
						<div>
							...
							<div class="p-6 text-left">
								<p class="text-xs text-poppy-muted leading-relaxed mb-6 font-medium">
									Membantu anak memahami struktur kalimat, memperkaya kosakata, dan meningkatkan kepercayaan diri dalam menggunakan Bahasa Inggris.
								</p>
							</div>
						</div>
						<!-- Footer/Price -->
					...
					<div class="bg-white rounded-[24px] overflow-hidden shadow-md flex flex-col justify-between border-b-[8px] border-poppy-ink">
						<div>
							...
							<div class="p-6 text-left">
								<p class="text-xs text-poppy-muted leading-relaxed mb-6 font-medium">
									Fokus pada kemampuan berbicara melalui praktik percakapan sehari-hari, diskusi ringan, dan aktivitas komunikasi yang interaktif.
								</p>
							</div>
						</div>
						<!-- Footer/Price -->
