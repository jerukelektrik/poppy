...
function poppy_whatsapp_floating_button(): void {
	...
	<div class="md:hidden fixed bottom-0 left-0 right-0 z-[9999] bg-poppy-accent px-5 py-3 flex items-center justify-between shadow-[0_-8px_24px_rgba(19,32,57,0.16)] rounded-t-2xl select-none pointer-events-auto">
		<span class="text-sm font-extrabold text-white">Tanya Airlangga via WhatsApp</span>
		<a href="<?php echo esc_url( $url ); ?>" target="_blank" rel="noopener noreferrer" class="w-10 h-10 rounded-full bg-white flex items-center justify-center shadow-md hover:scale-105 transition duration-300 focus:outline-none">
			<!-- WhatsApp SVG Icon (Green on white circle) -->
			<svg class="w-5 h-5 fill-current text-[#25D366]" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
