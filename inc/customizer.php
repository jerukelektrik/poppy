...
function poppy_whatsapp_floating_button(): void {
	...
	<div class="fixed bottom-6 <?php echo esc_attr( $position_class ); ?> z-[9999] flex items-center gap-3 group pointer-events-auto select-none">
		...
		<a href="<?php echo esc_url( $url ); ?>" target="_blank" rel="noopener noreferrer" style="background-color: #25D366;" class="w-12 h-12 md:w-14 md:h-14 hover:bg-[#20BA5A] text-white rounded-full flex items-center justify-center shadow-lg hover:shadow-xl hover:scale-110 transition duration-300 focus:outline-none relative <?php echo 'bottom_left' === $position ? 'order-1' : ''; ?>">
			<!-- WhatsApp SVG Icon -->
